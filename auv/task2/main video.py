...
url = "rtsp://admin:Oirov*123@169.254.80.219:554/Streaming/Channels/101"
...
while cap.isOpened():
    ...
    try:
        ...
        response = requests.post("https://detect.roboflow.com/detect-bucket/1?api_key=g4UYfCP9NKvFIlzAhIzn", data=m, headers={'Content-Type': m.content_type})
